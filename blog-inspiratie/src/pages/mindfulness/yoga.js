...
export const Yoga = () => {
  ...
  const poses = [
    {
      name: "Balasana",
      img: "https://rishikeshyogavalley.com/wp-content/uploads/2024/12/Utthita-Balasana-Extended-Childs-Pose.jpg.webp",
    ...
    {
      name: "Vrksasana",
      img: "https://rishikeshyognirvana.com/blog/images/vrksasana.webp",
    ...
    {
      name: "Tadasana",
      img: "https://www.yogabasics.com/yogabasics2017/wp-content/uploads/2013/11/Tadasana_2280.jpg",
    ...
    {
      name: "Marjaryasana",
      img: "https://www.hrishikeshyoga.com/blog/wp-content/uploads/2023/03/marjaryasana-cat-pose.png",
    ...
    },
    {
      ...
      img: "https://www.yogateket.com/image/original/downwardfacingdog.jpg",
    ...
    {
      name: "Trikonasana",
      img: "https://media.graphassets.com/resize=fit:clip,height:350,width:600/eUAcAJPbS1291h0XEJgx",
    ...
    },
    {
      ...
      img: "https://cdn.yogajournal.com/wp-content/uploads/2022/10/Bound-Angle-Pose_Mod-1_Andrew-Clark_2400x1350.jpeg",
    ...
    {
      name: "Padmasana",
      img: "https://www.yoga.patanjali.jp/wp-content/uploads/2022/07/Untitled-design-1.png",
    ...
    },
    {
      ...
      img: "https://www.yogasat.ro/sites/default/files/article/ardha-matsyendrasana-noua-asana-de-baza-din-hatha-yoga/ardha-matsyendrasana-noua-asana-de-baza-din-hatha-yoga_0.jpg",
      gif: "https://64.media.tumblr.com/579036645724926507ad63f85dc0b420/tumblr_o8puatTtBy1rysr6eo1_400.gif",
      description: [
      "Ardha Matsyendrasana (Poza Jumătate de Lord al Peștilor/Poza de răsucire așezată) este o răsucire profundă, restauratoare, care este atât întăritoare, cât și întineritoare. Întregul trunchi se răsucește în poziție, ceea ce îmbunătățește circulația, ajută la digestia și îmbunătățește mobilitatea coloanei vertebrale.",
    ...
    {
      name: "Marichyasana I",
      img: "https://cdn.yogajournal.com/wp-content/uploads/2007/08/Woman-Doing-Pose-Dedicated-to-the-Sage-Marichi-I-1.jpg",
    ...
    <div className="container-all" onClick={handleClickOutside}>
      <div className="all-wrapper">
        <div className="all-category">
          <h1>Yoga: Arta Echilibrului și Relaxării</h1>
          <hr className="dashed-line" />
        </div>
        <div className="all-container">
          <section className="yoga-intro">
            <div className="yoga-title">Ce este Yoga?</div>
            <p>Trăim într-o lume stresantă. De la locurile noastre de muncă, incertitudinea cu privire la viitor și relațiile stresate până la un echilibru mereu provocator dintre muncă și viață personală creează mai multă anxietate și stres în viața noastră.</p>
            <p>Pentru a scăpa de acest stres și anxietate, apelăm la diferite măsuri. Un astfel de mod sigur de a ține stresul la distanță este yoga. Calitățile sale terapeutice ajută la reglarea emoțiilor și au un impact pozitiv.</p>
            <p>Lumea se luptă din ce în ce mai mult cu scăderea bunăstării mintale. Și toți avem nevoie de acea singură sursă care poate aduce mai multă calm, stabilitate, energie pozitivă, relaxare și pace în viața noastră. Și yoga este acea sursă. O practică indiană străveche, yoga este o modalitate eficientă de a vă menține corpul în formă, în același timp cu un impact pozitiv asupra minții și sufletului.</p>
            <p>Practicând yoga calmantă și yoga pentru sistemul nervos, poți simți o diferență instantanee în viața ta. Da, există poziții speciale de yoga pentru sănătatea mintală și asane pe care le puteți practica pentru a vă calma mintea și a vă relaxa sistemul nervos. Nu doar atât, yoga vă îmbunătățește și sănătatea fizică. Yoga regulată poate crește nivelul de energie și vitalitate, îmbunătăți flexibilitatea și forța.</p>
            <img src="https://www.viata-medicala.ro/upload/media/yoga.jpg" alt="Practicanți de yoga în natură" className="yoga-image" />
          </section>
          <section className="yoga-types">
            <div className='pose-title'>Tipuri de Yoga</div>
            <p>Există mai multe stiluri de yoga, fiecare având propriile sale caracteristici:</p>
            <ul>
              <li><b>Hatha Yoga</b> - Perfectă pentru începători, pune accent pe poziții și respirație.</li>
              <li><b>Vinyasa Yoga</b> - Mișcări fluide sincronizate cu respirația.</li>
              <li><b>Ashtanga Yoga</b> - Un stil dinamic și intens.</li>
              <li><b>Yin Yoga</b> - Posturi menținute mai mult timp pentru relaxare profundă.</li>
              <li><b>Bikram Yoga</b> - Înseamnă o serie de 26 de posturi practicate într-o cameră încălzită la 40ºC.</li>
            </ul>
            <img src="https://mediacdn.libertatea.ro/unsafe/1260x708/smart/filters:format(webp):contrast(8):quality(75)/https://static4.libertatea.ro/wp-content/uploads/2022/07/pozitii-de-yoga-pentru-incepatori.jpg" alt="Tipuri de yoga" className="yoga-image" />
          </section>
          <section className="yoga-beneficii">
            <div className='pose-beneficii'>Principalele beneficii ale practicii yoga</div>
            <p>Sistematicitatea în yoga este cheia pentru a obține multe beneficii pentru sănătate, nu doar fizică, ci și mentală. Iată care sunt principalele beneficii ale practicii yoga:</p>
            <ul>
              <li> Îmbunătățirea performanțelor și a condiției fizice.</li>
              <li> Alungirea coloanei vertebrale, deschiderea cutiei toracice și îmbunătățirea posturii.</li>
              <li> Reducerea sau eliminarea completă a durerilor de spate și articulare.</li>
              <li> Dezvoltarea unei tehnici corecte de respirație și o mai bună oxigenare a corpului.</li>
              <li> Îmbunătățirea coordonării și a echilibrului.</li>
              <li> O mai mare conștientizare a corpului și senzații profunde.</li>
              <li> Întărirea forței și rezistenței mușchilor și oaselor (risc mai mic de osteoporoză).</li>
              <li> Flexibilitate, mobilitate și suplețe sporite.</li>
              <li> Îmbunătățirea sistemului cardiovascular (de exemplu, reglarea tensiunii arteriale), a sistemului respirator (creșterea capacității pulmonare), a sistemului endocrin și a organelor interne.</li>
              <li> Îmbunătățirea proceselor digestive</li>
              <li> Îmbunătățirea stării pielii - este mai fermă</li>
              <li> Îmbunătățirea excreției toxinelor, a radicalilor liberi și a produselor metabolice dăunătoare.</li>
              <li> Întârzierea procesului de îmbătrânire.</li>
              <li> Accelerează metabolismul și sprijină reducerea grăsimilor și îmbunătățirea formei corpului.</li>
              <li> Un mai bun control al emoțiilor.</li>
              <li> Realizarea echilibrului intern.</li>
              <li> Relaxare, reducerea stresului și a tensiunii.</li>
              <li> O pauză de la problemele cotidiene și o concentrare pe a fi „aici și acum”.</li>
              <li> Îmbunătățirea percepției de sine.</li>
            </ul>
          </section>
          <section className="poses-section">
            <div className='pose-title'>Pozitii in Yoga</div>
                  ...
                  {selectedPose === pose.name && (
                    <div className="pose-description">
                      <div className='intro-section'>
                       ...
                       {pose.description.map((description, index) => (
                      ...
                      <ol>
                        <h3>Sfaturi</h3>
                          {pose.sfaturi.map((sfaturi, index) => (
                            <p key={index}>{sfaturi}</p>
                          ))}
                        </ol>
                      </div>
                    </div>

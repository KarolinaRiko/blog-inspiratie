...
import plasture from "../plasture.png";
...
const About = () => {
  return (
    <div className="about-container">
      <img src={plasture} alt="Plasture" className="plasture" />
      ...
      <div className="about-content">
        ...
        <ul>
          <li>Recomandări de cărți</li>
          <li>Idei pentru antrenamente interesante</li>
          <li>Rețete sănătoase și delicioase</li>
          <li>Cunoasterea partii de spiritualitate</li>
        </ul>
 
        <h2>Conecteaza-te cu Inspirație</h2>
        <ul>
